...
func (c *deviceConfig) TargetSpecificHeaderPath() string {
	return String(c.config.productVariables.Corvus.Target_specific_header_path)
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Corvus.Specific_camera_parameter_library)
}
